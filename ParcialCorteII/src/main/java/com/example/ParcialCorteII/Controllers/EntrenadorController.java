...
import com.example.ParcialCorteII.Services.EntrenadorService;
...
public class EntrenadorController {
    ...
    @Autowired
    public EntrenadorService service;

    @GetMapping("")
    public ResponseEntity<?> listarTodo()
    {
        try {
            List<Entrenador> response = service.ListarTodo();
            if(response.isEmpty())
            {
    ...
    {
        try {
            Entrenador response = service.buscarPorId(id);
            if (response == null)
            {
    ...
    @PostMapping("")
    public ResponseEntity<?> crear(@RequestBody Entrenador input)
    {
        try {
            service.crear(input);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> actualizar (@PathVariable int id, @RequestBody Entrenador input)
    {
        try{
